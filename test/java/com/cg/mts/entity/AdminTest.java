...
public class AdminTest {
	...
	public static void setUp() {
		...
		ad=new Admin("sharmistha","0903234157");
	}
	@BeforeEach
	...
	public void testAdmin() {
		Admin ad=new Admin("sharmistha","0903234157");
		assertNotNull(ad);
		Admin adOne=null;
		assertNull(adOne);
	}
	...
	public void testGetters() {
		assertEquals("sharmistha",ad.getAdminName());
		assertEquals("0903234157",ad.getAdminContact());
		assertNotEquals("9903234150", ad.getAdminContact());
		assertNotEquals("990323415", ad.getAdminContact());
	...
	**/
	...
	public static void stopAll() {
		...
		ad = null;//now after assigning ad object to null it is eligible for removing from the memory
	}
